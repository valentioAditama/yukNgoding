        ...
        <main>
                                    ...
                                    <div class="card-body">
                                        <div className="row d-flex align-items-center justify-content-center">
                                            <div className="col-md-6">
                                                <Icon icon={'material-symbols:breaking-news-alt-1-outline'} style={{ fontSize: '80px' }}></Icon>
                                            </div>
                                            <div className="col-md-6">
            ...
            <label htmlFor="modal-add" className="modal cursor-pointer">
                <label className="modal-box relative" htmlFor="">
                    <h3 className="text-lg font-bold">Add Data News</h3>
                    <form action="">
                        <div className="mb-3">
            ...
            <label htmlFor="modal-delete" className="modal cursor-pointer">
                <label className="modal-box relative" htmlFor="">
                    <h3 className="text-lg font-bold">Delete Data News</h3>
